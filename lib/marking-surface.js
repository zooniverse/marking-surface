...
(function() {
  var BACKSPACE, BaseClass, CASE_SENSITIVE_ATTRIBUTES, DELETE, ElementBase, FILTER_ID_PREFIX, IE_HACK_ID, Mark, MarkingSurface, NAMESPACES, NON_ATTRIBUTE_PROPERTIES, POINTER_EVENTS, PREFIXED_GRAB, PREFIXED_GRABBING, SVG, TAB, Tool, ToolControls, insertStyle, invertFilter, invertTransfer, shadowFilter, shadowMerge, _ref, _ref1,
  ...
  MarkingSurface = (function(_super) {
    ...
    function MarkingSurface() {
      ...
      this.addEvent('mousedown', this.onStart);
    ...
    MarkingSurface.prototype.onStart = function(e) {
      var dragEvent, releaseEvent, tool, _ref2, _ref3, _ref4;
      if (this.disabled) {
        return;
      }
      ...
      if (_ref2 = e.target, __indexOf.call(this.el.querySelectorAll("." + ToolControls.prototype.className), _ref2) >= 0) {
        return;
      }
      if (_ref3 = e.target, __indexOf.call(this.el.querySelectorAll("." + ToolControls.prototype.className + " *"), _ref3) >= 0) {
        return;
      }
      e.preventDefault();
      tool = (this.selection == null) || ((_ref4 = this.selection) != null ? _ref4.isComplete() : void 0) ? this.addTool() : this.selection;
      tool.select();
    ...
    MarkingSurface.prototype.onKeyDown = function(e) {
      ...
      if ((_ref2 = e.which) === BACKSPACE || _ref2 === DELETE || _ref2 === TAB) {
        e.preventDefault();
        switch (e.which) {
          case BACKSPACE:
          case DELETE:
    ...
    MarkingSurface.prototype.tabSelectNext = function(reverse) {
      var current, next, _ref2;
      if (reverse) {
        if ((_ref2 = this.tools[0]) != null) {
          _ref2.select();
        }
      } else {
        ...
        if (next != null) {
          next.select();
          if (current != null) {
            this.tools.splice(this.tools.indexOf(current), 1);
