...
(function() {
  ...
  ElementBase = (function(_super) {
    ...
    ElementBase.instances = {};

    ElementBase.prototype.id = '';
    ...
    function ElementBase() {
      ...
      this.id || (this.id = ("" + (Math.random())).split('.')[1]);
      this.attr('data-marking-surface-id', this.id);
    ...
    ElementBase.prototype.removeChildren = function() {
      var child, childInstance, _i, _len, _ref, _results;
      _ref = Array.prototype.slice.call(this.el.children);
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        child = _ref[_i];
        if (child.hasAttribute('data-marking-surface-id')) {
          childInstance = this.constructor.instances[child.getAttribute('data-marking-surface-id')];
          _results.push(childInstance.remove());
        } else {
          _results.push(void 0);
        }
      }
    ...
    ElementBase.prototype.destroy = function() {
      ...
      this._delegatedListeners = null;
      ElementBase.__super__.destroy.apply(this, arguments);
      this.constructor[this.id] = null;
      return this.el = null;
    };
