...
(function() {
  ...
  Tool = (function(_super) {
    ...
    Tool.prototype.handleEvents = function(e) {
      var endEvent, endHandler, eventName, matchingNames, moveEvent, moveHandler, property, target, value, valueItem, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _results, _results1,
        _this = this;
      ...
      switch (eventName) {
        ...
        case 'touchmove':
          ...
          for (_k = 0, _len2 = matchingNames.length; _k < _len2; _k++) {
            ...
            _results.push((_ref5 = this["on *move " + name]) != null ? _ref5.call(this, e) : void 0);
          }
          return _results;
          break;
        case 'mousedown':
