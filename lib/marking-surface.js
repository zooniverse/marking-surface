...
(function() {
  var BACKSPACE, BaseClass, CASED_ATTRIBUTES, DELETE, Mark, MarkingSurface, SVG, SVG_NS, TAB, Tool, ToolControls, addEvent, elementAndParents, events, jQuery, matchesSelector, removeEvent,
  ...
  BaseClass = (function() {
    ...
    function BaseClass(params) {
      ...
      this.jQueryEventProxy = new jQuery({});
    }
  ...
  ToolControls = (function(_super) {
    ...
    ToolControls.prototype.moveTo = function(x, y) {
      ...
      return this.el.style.display = hidden ? 'none' : '';
    };
    ...
    ToolControls.prototype.onToolSelect = function() {
      return this.el.classList.add('selected');
    };

    ToolControls.prototype.onToolDeselect = function() {
      return this.el.classList.remove('selected');
    };
    ...
    ToolControls.prototype.render = function() {
      ...
      if ('_label' in this.tool.mark) {
        return (_ref = this.label) != null ? _ref.innerHTML = this.tool.mark._label : void 0;
      }
    };
