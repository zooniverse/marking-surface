...
(function() {
  ...
  Tool = (function(_super) {
    ...
    function Tool() {
      ...
      this.mark.on('change', [this, 'render']);
      this.mark.on('change', [this, 'trigger', 'change']);
  ...
  MarkingSurface = (function(_super) {
    ...
    function MarkingSurface() {
      ...
      this.on('destroy', [this.sizeRect, 'destroy']);
      this.root = this.svg.addShape('g.marking-surface-svg-root');
      this.on('destroy', [this.root, 'destroy']);
      ...
      }), this.on('destroy', [container, 'destroy']), this.el.appendChild(container.el), container) : void 0;
      ...
      }), this.on('destroy', [input, 'destroy']), input.el.tabIndex = -1, input.el.name = this.inputName, this.on('change', [this, 'updateInput']), this.el.appendChild(input.el), input) : void 0;
    }
