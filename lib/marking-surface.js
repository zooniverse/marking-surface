...
(function() {
  ...
  MarkingSurface = (function(_super) {
    ...
    function MarkingSurface() {
      ...
      toggleClass(this.el, MarkingSurface.prototype.className, true);
      if (this.constructor.prototype.className !== MarkingSurface.className) {
        toggleClass(this.el, this.constructor.prototype.className, true);
      }
    ...
    MarkingSurface.prototype.createTool = function() {
      ...
      tool.on('select', function() {
        ...
        removeFrom(_this.selection, _this.tools);
      ...
      tool.mark.on('destroy', function() {
        removeFrom(tool.mark, _this.marks);
    ...
    MarkingSurface.prototype.tabSelect = function(reverse) {
    ...
    MarkingSurface.prototype.destroy = function() {
      this.reset();
      this.el.removeEventListener('mousedown', this.onStart, false);
    ...
    MarkingSurface.prototype.pointerOffset = function(e) {
      ...
      _ref2 = this.el.getBoundingClientRect(), left = _ref2.left, top = _ref2.top;
