...
(function() {
  var BaseClass, CASE_SENSITIVE_ATTRIBUTES, DEV_PORT, ElementBase, FILTER_ID_PREFIX, KEYS, LOG_EVENTS, Mark, MarkingSurface, NAMESPACES, NON_ATTRIBUTE_PROPERTIES, SVG, Tool, ToolControls, ToolFocusTarget, ToolLabel, arraysMatch, insertStyle, matchesSelector,
    __slice = [].slice,
  ...
  insertStyle = (function() {
    ...
    return function(id, styleContent) {
      var ieHackElement;
      document.querySelector('head > :first-child').insertAdjacentHTML('beforeBegin', "<span id=\"" + IE_HACK_ID + "\"></span>\n<style id=\"" + id + "\">" + styleContent + "</style>");
  ...
  BaseClass = (function() {
    ...
    BaseClass.prototype.off = function(eventName, handler) {
      var h, handlerIndex, handlerList, i, property, _ref, _results;
      if (eventName != null) {
        if (eventName in this._events) {
          handlerList = this._events[eventName];
          if (handler != null) {
            handlerIndex = handler instanceof Array ? (_ref = ((function() {
              var _i, _results;
              _results = [];
              for (i = _i = handlerList.length - 1; _i >= 0; i = _i += -1) {
                h = handlerList[i];
                if (arraysMatch(handler, h)) {
                  _results.push(i);
                }
              }
              return _results;
            })())[0]) != null ? _ref : -1 : handlerList.indexOf(handler);
            if (handlerIndex >= 0) {
        ...
        for (property in this._events) {
          _results.push(this._events[property].splice(0));
        }
        return _results;
      }
    };
  ...
  ElementBase = (function(_super) {
    ...
    ElementBase.prototype._onRelease = function(e) {
      ...
      if (e.target === this._startEvent.target) {
        this.dispatchEvent('click', {
          originalEvent: e
        });
        this.dispatchEvent('marking-surface:element:click', {
          originalEvent: e
        });
      }
  ...
  ToolControls = (function(_super) {
    ...
    ToolControls.prototype.moveTo = function(_arg) {
      var height, outOfBounds, width, x, y, _ref;
      x = _arg.x, y = _arg.y;
      _ref = this.tool.markingSurface.scalePixelToScreen({
        x: x,
        y: y
      }), x = _ref.x, y = _ref.y;
  ...
  ToolFocusTarget = (function(_super) {
    ...
    ToolFocusTarget.prototype.onKeydown = function(e) {
      var index, next, noShortcutCalled, siblingFocusTargets, _ref;
      if (!(e.metaKey || e.ctrlKey || e.altKey)) {
        switch (e.which) {
          case KEYS["delete"]:
            ...
            break;
          case KEYS.esc:
            if ((_ref = this.tool.markingSurface.selection) != null) {
              _ref.deselect();
            }
            break;
          default:
    ...
    ToolFocusTarget.prototype.followTool = function() {
      var _ref;
      return (_ref = this.tool.markingSurface.toolFocusTargetsContainer) != null ? _ref.el.appendChild(this.el) : void 0;
    };
  ...
  ToolLabel = (function(_super) {
    ...
    function ToolLabel() {
      return ToolLabel.__super__.constructor.apply(this, arguments);
    }
    ...
    ToolLabel.prototype.setContent = function(html) {
      var _ref;
      return (_ref = this.el) != null ? _ref.innerHTML = html : void 0;
    };
  ...
  Tool = (function(_super) {
    ...
    function Tool() {
      ...
      this.mark.on('marking-surface:mark:change', [this, 'throttleRender']);
    ...
    Tool.prototype.addShape = function() {
      var _ref;
      return (_ref = this.root).addShape.apply(_ref, arguments);
    };
    ...
    Tool.prototype.throttleRender = function() {
      var args, doRender;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      doRender = (function(_this) {
        return function() {
          _this.renderTimeout = NaN;
          return _this.render.apply(_this, args);
        };
      })(this);
      if (isNaN(this.renderTimeout)) {
        this.render.apply(this, args);
        return this.renderTimeout = setTimeout(doRender, 1000 / this.fps);
      }
    };

    Tool.prototype.render = function() {
      this.attr('data-complete', this.isComplete() || null);
  ...
  MarkingSurface = (function(_super) {
    ...
    MarkingSurface.prototype._onStart = function(e) {
      var tool, _ref;
      if (matchesSelector(e.target, ['.marking-surface-tool', '.marking-surface-tool *', '.marking-surface-tool-controls-container *'].join(','))) {
        return;
      }
      e.preventDefault();
      tool = (this.selection == null) || ((_ref = this.selection) != null ? _ref.isComplete() : void 0) ? this.tool != null ? this.addTool() : void 0 : this.selection;
      if (tool != null) {
        tool.select();
    ...
    MarkingSurface.prototype._onMove = function(e) {
      ...
      return (_ref = this.selection) != null ? _ref.onInitialMove(e) : void 0;
    };

    MarkingSurface.prototype._onRelease = function(e) {
      var _ref;
      MarkingSurface.__super__._onRelease.apply(this, arguments);
      return (_ref = this.selection) != null ? _ref.onInitialRelease(e) : void 0;
    };

    MarkingSurface.prototype.rescale = function(x, y, width, height) {
      var currentViewBox, scaled, _ref, _ref1, _ref2, _ref3, _ref4;
      currentViewBox = (_ref = this.svg.attr('viewBox')) != null ? _ref.split(/\s+/) : void 0;
      if (x == null) {
        x = (_ref1 = currentViewBox != null ? currentViewBox[0] : void 0) != null ? _ref1 : 0;
      }
      if (y == null) {
        y = (_ref2 = currentViewBox != null ? currentViewBox[1] : void 0) != null ? _ref2 : 0;
      }
      if (width == null) {
        width = (_ref3 = currentViewBox != null ? currentViewBox[2] : void 0) != null ? _ref3 : 0;
      }
      if (height == null) {
        height = (_ref4 = currentViewBox != null ? currentViewBox[3] : void 0) != null ? _ref4 : 0;
      }
