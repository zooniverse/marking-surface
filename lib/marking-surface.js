...
(function() {
  var BACKSPACE, BaseClass, DELETE, END, MOUSE_EVENTS, MOVE, Mark, MarkingSurface, START, TAB, TOUCH, Tool, ToolControls, addEvent, events, matchesSelector, removeEvent, _ref,
  ...
  matchesSelector = function(element, selector) {
    ...
    return __indexOf.call(document.querySelectorAll(selector), element) >= 0;
  };

  events = {};

  addEvent = function() {
    var delegatedHandler, element, eventName, handler, selector, _arg, _i, _ref1;
    ...
    if ((_ref1 = events[eventName]) == null) {
      events[eventName] = [];
    }
  ...
  removeEvent = function() {
    var element, eventName, handler, i, selector, set, _arg, _i, _j, _len, _ref1;
    element = arguments[0], _arg = 4 <= arguments.length ? __slice.call(arguments, 1, _i = arguments.length - 2) : (_i = 1, []), eventName = arguments[_i++], handler = arguments[_i++];
    selector = _arg[0];
