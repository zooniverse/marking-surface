...
(function() {
  var BaseClass, CASE_SENSITIVE_ATTRIBUTES, ElementBase, FILTER_ID_PREFIX, KEYS, LOG_EVENTS, Mark, MarkingSurface, NAMESPACES, NON_ATTRIBUTE_PROPERTIES, SVG, Tool, ToolControls, ToolFocusTarget, ToolLabel, insertStyle, matchesSelector, _ref, _ref1,
    __slice = [].slice,
  ...
  ToolControls = (function(_super) {
    ...
    function ToolControls() {
      ...
      this.tool.on('marking-surface:tool:select', [this, 'toFront']);
      this.tool.on('marking-surface:tool:select', [this, 'attr', 'data-selected', true]);
      this.tool.on('marking-surface:tool:deselect', [this, 'attr', 'data-selected', null]);
      this.tool.on('marking-surface:element:remove', [this, 'remove']);
      this.tool.on('marking-surface:base:destroy', [this, 'destroy']);
  ...
  ToolFocusTarget = (function(_super) {
    ...
    function ToolFocusTarget() {
      ...
      this.el.type = 'button';
      this.tool.on('marking-surface:tool:focus', [this.el, 'focus']);
  ...
  Tool = (function(_super) {
    ...
    function Tool() {
      ...
      this.mark.on('marking-surface:mark:change', [this, 'trigger', 'marking-surface:mark:change']);
    ...
    Tool.prototype.onInitialStart = function(e) {
      this.select();
      return this.trigger('marking-surface:tool:initial-click', [e]);
    };

    Tool.prototype.onInitialMove = function(e) {
      return this.trigger('marking-surface:tool:initial-drag', [e]);
    };

    Tool.prototype.onInitialRelease = function(e) {
      this.movements += 1;
      return this.trigger('marking-surface:tool:initial-release', [e]);
    };
    ...
    Tool.prototype.focus = function() {
      ...
      return this.trigger('marking-surface:tool:focus');
    };

    Tool.prototype.blur = function() {
      this.attr('data-focused', null);
      return this.trigger('marking-surface:tool:blur');
    };
    ...
    Tool.prototype.select = function() {
      ...
      return this.trigger('marking-surface:tool:select');
    };

    Tool.prototype.deselect = function() {
      this.attr('data-selected', null);
      return this.trigger('marking-surface:tool:deselect');
    };
    ...
    Tool.prototype.destroy = function() {
      ...
      this.root.destroy();
      this.selectedRoot.destroy();
      return this.focusRoot.destroy();
    };
  ...
  MarkingSurface = (function(_super) {
    ...
    function MarkingSurface() {
      ...
      this.svg.addEvent('marking-surface:base:destroy', '.marking-surface-tool', [this, 'onDestroyTool']);
