...
(function() {
  var BACKSPACE, BaseClass, CASE_SENSITIVE_ATTRIBUTES, DELETE, FILTERS, Mark, MarkingSurface, NAMESPACES, POINTER_EVENTS, SVG, SVG_NS, TAB, Tool, ToolControls, attributes, defs, element, elements, filter, id, removeFrom, toggleClass, _i, _len, _ref, _ref1,
  ...
  SVG = (function() {
    ...
    SVG.prototype.attr = function(attribute, value) {
      ...
      if (typeof attribute === 'string') {
        ...
        this.el.setAttributeNS(namespace, attribute, value);
      } else {
    ...
    SVG.prototype.filter = function(filter) {
      return this.attr('filter', filter != null ? "url(#marking-surface-filter-" + filter + ")" : '');
    };
  ...
  ToolControls = (function(_super) {
    ...
    function ToolControls() {
      ...
      if ((_ref2 = this.deleteButton) != null) {
        _ref2.addEventListener('click', this.onClickDelete, false);
      }
    ...
    ToolControls.prototype.moveTo = function(x, y) {
      var bottom, height, left, outOfBounds, panX, panY, right, top, width, zoomBy, _ref2, _ref3, _ref4;
      _ref2 = this.tool.surface, zoomBy = _ref2.zoomBy, panX = _ref2.panX, panY = _ref2.panY, width = _ref2.width, height = _ref2.height;
      panX *= width - (width / zoomBy);
      panY *= height - (height / zoomBy);
      _ref3 = x < width / 2 ? [(x * zoomBy) - (panX * zoomBy), null] : [null, width - ((x * zoomBy) - (panX * zoomBy))], left = _ref3[0], right = _ref3[1];
      _ref4 = y < height / 2 ? [(y * zoomBy) - (panY * zoomBy), null] : [null, height - ((y * zoomBy) - (panY * zoomBy))], top = _ref4[0], bottom = _ref4[1];
  ...
  POINTER_EVENTS = ['mousedown', 'mouseover', 'mousmove', 'mouseout', 'mouseup', 'touchstart', 'touchmove', 'touchend'];
  ...
  Tool = (function(_super) {
    ...
    function Tool() {
      ...
      for (_j = 0, _len1 = POINTER_EVENTS.length; _j < _len1; _j++) {
        eventName = POINTER_EVENTS[_j];
    ...
    Tool.prototype.handleEvents = function(e) {
      var dragEvent, endEvent, eventName, match, name, onEnd, onNamedEnd, property, target, value, valueItem, _j, _len1, _ref2, _ref3, _ref4,
        _this = this;
      ...
      switch (eventName) {
        case 'mouseover':
          return this.surface.el.style.cursor = (_ref4 = this.cursors) != null ? _ref4[name] : void 0;
        case 'mouseout':
  ...
  MarkingSurface = (function(_super) {
    ...
    MarkingSurface.prototype.pan = function(panX, panY) {
      var height, minX, minY, tool, width, _j, _len1, _ref2;
    ...
    MarkingSurface.prototype.onKeyDown = function(e) {
      var current, next, _ref2, _ref3, _ref4;
      if (this.disabled) {
        return;
      }
      ...
      switch (e.which) {
        ...
        case TAB:
          e.preventDefault();
          if (e.shiftKey) {
            return (_ref4 = this.tools[0]) != null ? _ref4.select() : void 0;
          } else {
            e.preventDefault();
    ...
    MarkingSurface.prototype.addShape = function() {
      var _ref2;
      return (_ref2 = this.svg).addShape.apply(_ref2, arguments);
    };
    ...
    MarkingSurface.prototype.pointerOffset = function(e) {
      ...
      _ref2 = this.offsetAtLastMousedown || this.elOffset(), left = _ref2.left, top = _ref2.top;
      x = e.pageX - left;
      y = e.pageY - top;
      return {
        x: x,
