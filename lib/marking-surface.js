...
(function() {
  ...
  MarkingSurface = (function(_super) {
    ...
    function MarkingSurface() {
      ...
      }), this.el.appendChild(container.el), this.on('destroy', [container, 'destroy']), container) : void 0;
    ...
    MarkingSurface.prototype.destroy = function() {
      this.reset();
      this.root.destroy();
      this.sizeRect.destroy();
      this.svg.destroy();
      this.toolFocusTargetsContainer.destroy();
      this.toolControlsContainer.destroy();
