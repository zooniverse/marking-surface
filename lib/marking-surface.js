...
(function() {
  ...
  ToolControls = (function(_super) {
    ...
    ToolControls.prototype.onMarkChange = function() {
      return this.label.html(this.tool.mark.label);
    };
    ...
    ToolControls.prototype.onMouseDown = function(e) {
    ...
    ToolControls.prototype.select = function() {
      return this.el.addClass('selected');
    };

    ToolControls.prototype.deselect = function() {
  ...
  Tool = (function(_super) {
    ...
    Tool.prototype.onMarkChange = function() {
      var _ref;
      (_ref = this.controls).onMarkChange.apply(_ref, arguments);
      return this.render.apply(this, arguments);
    };

    Tool.prototype.onClickDelete = function(e) {
      this.mark.destroy();
      return this.surface.container.focus();
    };

    Tool.prototype.select = function() {
      var _ref;
      (_ref = this.controls).select.apply(_ref, arguments);
      this.shapeSet.attr({
        opacity: 1
      });
    ...
    Tool.prototype.deselect = function() {
      var _ref;
      (_ref = this.controls).deselect.apply(_ref, arguments);
      this.shapeSet.attr({
        opacity: 0.5
      });
