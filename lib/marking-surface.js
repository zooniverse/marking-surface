...
(function() {
  var BACKSPACE, BaseClass, CASE_SENSITIVE_ATTRIBUTES, DELETE, FILTERS, FILTERS_CONTAINER, Mark, MarkingSurface, NAMESPACES, POINTER_EVENTS, SVG, SVG_NS, TAB, Tool, ToolControls, defs, removeFrom, shadow, toggleClass, _ref,
  ...
  SVG = (function() {
    ...
    SVG.prototype.filter = function(filter) {
      return this.attr('filter', filter != null ? "url(#" + FILTERS[filter] + ")" : '');
    };
  ...
  shadow = defs.addShape('filter', {
    id: FILTERS.shadow
  });

  shadow.addShape('feOffset', {
    "in": 'SourceAlpha',
    dx: '1',
    dy: '2',
    result: 'offOut'
