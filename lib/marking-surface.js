...
(function() {
  var $, BaseClass, Mark, MarkingSurface, Raphael, Tool, body, doc,
  ...
  Tool = (function(_super) {
    ...
    Tool.prototype.handleEvents = function(e) {
      var name, onDrag, onNamedDrag, shape, type, _ref, _ref1,
        _this = this;
      type = e.type;
      for (name in this) {
        shape = this[name];
    ...
    Tool.prototype.destroy = function() {
      var _this = this;
      this.shapeSet.animate({
        transform: '...s0.01'
      }, 250, 'ease-out', function() {
        _this.shapeSet.remove();
        return _this.deleteButton.remove();
      });
  ...
  MarkingSurface = (function(_super) {
    ...
    MarkingSurface.prototype.image = '';
    ...
    function MarkingSurface(params) {
      ...
      this.background = this.paper.image(this.image, 0, 0, this.width, this.height);
    ...
    MarkingSurface.prototype.onMouseDown = function(e) {
      ...
      if ((_ref = e.target) !== this.container.get(0) && _ref !== this.paper.canvas && _ref !== this.background.node) {
        return;
      }
      ...
      if (!(this.selection != null) || this.selection.isComplete()) {
        ...
        tool.on('selected', function() {
          ...
          index = _this.tools.indexOf(tool);
        ...
        tool.on('destroyed', function() {
          ...
          if (tool === _this.selection) {
            return (_ref1 = _this.tools[_this.tools.length - 1]) != null ? _ref1.select() : void 0;
          }
        });
        mark.on('destroyed', function() {
          var index;
          index = _this.marks.indexOf(mark);
