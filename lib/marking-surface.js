...
(function() {
  var BACKSPACE, BaseClass, CASE_SENSITIVE_ATTRIBUTES, DELETE, Mark, MarkingSurface, POINTER_EVENTS, SVG, SVG_NS, TAB, Tool, ToolControls, removeFrom, toggleClass, _ref,
  ...
  MarkingSurface = (function(_super) {
    ...
    MarkingSurface.prototype.pointerOffset = function(e) {
      ...
      _ref1 = this.offsetAtLastMousedown, left = _ref1.left, top = _ref1.top;
      x = e.pageX - left;
      y = e.pageY - top;
      return {
        x: x,
