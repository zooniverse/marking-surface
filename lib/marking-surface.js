...
(function() {
  ...
  Tool = (function(_super) {
    ...
    Tool.prototype.handleEvents = function(e) {
      ...
      if ((_ref = this["on " + type]) != null) {
        _ref.call.apply(_ref, [this].concat(__slice.call(arguments), [target]));
      }
      if (name) {
        if ((_ref1 = this["on " + type + " " + name]) != null) {
          _ref1.call.apply(_ref1, [this].concat(__slice.call(arguments), [target]));
        }
      }
      if (type === 'mouseover') {
        setTimeout(function() {
          var _ref2;
          return body.css({
            cursor: (_ref2 = _this.cursors) != null ? _ref2[name] : void 0
          });
        });
      }
      if (type === 'mouseout') {
      ...
      if (type === 'mousedown' || type === 'touchstart') {
        setTimeout($.proxy(this, 'select'), 100);
        e.preventDefault();
        if ('on drag' in this) {
    ...
    Tool.prototype.destroy = function() {
      ...
      for (_i = 0, _len = MOUSE_EVENTS.length; _i < _len; _i++) {
        eventName = MOUSE_EVENTS[_i];
        this.shapeSet["un" + eventName]($.proxy(this, 'handleEvents'));
      }
  ...
  MarkingSurface = (function(_super) {
    ...
    function MarkingSurface(params) {
      ...
      this.container.on('mousemove touchmove', $.proxy(this, 'onMouseMove'));
