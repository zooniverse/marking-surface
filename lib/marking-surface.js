...
(function() {
  var BACKSPACE, BaseClass, CASE_SENSITIVE_ATTRIBUTES, DELETE, Mark, MarkingSurface, NAMESPACES, NON_ATTRIBUTE_PROPERTIES, POINTER_EVENTS, PREFIXED_GRAB, PREFIXED_GRABBING, SVG, TAB, Tool, ToolControls, defs, elements, filters, name, removeFrom, toggleClass, _ref, _ref1,
  ...
  ToolControls = (function(_super) {
    ...
    ToolControls.prototype.destroy = function() {
      ...
      if ((_ref1 = this.deleteButton) != null) {
        _ref1.removeEventListener('click', this.onClickDelete, false);
      }
      this.el.parentNode.removeChild(this.el);
    ...
    ToolControls.prototype.moveTo = function(x, y, dontTryAndBeClever) {
      var bottom, height, left, panX, panY, right, top, width, zoomBy, _ref1, _ref2, _ref3;
      ...
      this.el.style.left = left != null ? "" + (Math.floor(left)) + "px" : '';
      this.el.style.right = right != null ? "" + (Math.floor(right)) + "px" : '';
      this.el.style.top = top != null ? "" + (Math.floor(top)) + "px" : '';
      this.el.style.bottom = bottom != null ? "" + (Math.floor(bottom)) + "px" : '';
  ...
  Tool = (function(_super) {
    ...
    Tool.prototype.handleEvents = function(e) {
      ...
      switch (eventName) {
        ...
        case 'mouseout':
          return this.surface.el.style.cursor = this.surface.defaultCursor;
      }
    };
  ...
  MarkingSurface = (function(_super) {
    ...
    MarkingSurface.prototype.defaultCursor = 'crosshair';
    ...
    function MarkingSurface() {
      ...
      this.el.style.cursor = this.defaultCursor;
