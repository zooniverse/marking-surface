...
(function() {
  ...
  BaseClass = (function() {
    ...
    BaseClass.prototype.applyHandler = function(handler, args) {
      var context, _ref;
      if (args == null) {
        args = [];
      }
      ...
      if (handler instanceof Array) {
        _ref = handler, context = _ref[0], handler = _ref[1];
      }
  ...
  ElementBase = (function(_super) {
    ...
    ElementBase.prototype.handleEvent = function(e) {
      var handler, handlers, match, moveTarget, selector, target, type, _i, _len, _ref, _ref1, _ref2, _ref3, _ref4, _results;
      if (!this.disabled) {
        if (e.currentTarget === window) {
          ...
          if ((_ref = e.detail) != null ? _ref.originalEvent : void 0) {
            ...
            moveTarget = (_ref1 = this._startEvent.target) != null ? _ref1 : this._startEvent.srcElement;
          }
          if (type in this._eventListeners) {
            _ref2 = this._eventListeners[type];
          ...
          if (type in this._delegatedListeners) {
            _ref3 = this._delegatedListeners[type];
            _results = [];
            for (selector in _ref3) {
              handlers = _ref3[selector];
              match = null;
              target = (_ref4 = moveTarget != null ? moveTarget : e.target) != null ? _ref4 : e.srcElement;
  ...
  Mark = (function(_super) {
    ...
    Mark.prototype.ignore = ['disabled', 'ignore'];
  ...
  Tool = (function(_super) {
    ...
    Tool.prototype.coords = function(e) {
      return this.markingSurface.toScale(this.markingSurface.pointerOffset(e));
    };

    Tool.prototype.scale = function(value) {
      return value / this.markingSurface.getScale();
    };
  ...
  MarkingSurface = (function(_super) {
    ...
    MarkingSurface.prototype.addTool = function(tool) {
      ...
      if (tool.focusTarget != null) {
        this.toolFocusTargetsContainer.el.appendChild(tool.focusTarget.el);
      }
    ...
    MarkingSurface.prototype.toScale = function(_arg) {
      ...
      if (this.svg.el.hasAttribute('viewBox')) {
        ...
        x += viewBox.x;
        x *= viewBox.width / this.el.offsetWidth;
        y += viewBox.y;
        y *= viewBox.height / this.el.offsetHeight;
      }
      return {
        x: x,
        y: y
