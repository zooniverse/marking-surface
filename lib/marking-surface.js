...
(function() {
  ...
  ToolControls = (function(_super) {
    ...
    ToolControls.prototype.moveTo = function(x, y) {
      ...
      _ref2 = x < width / 2 ? (this.el.classList.remove('to-the-left'), [(x * zoomBy) - (panX * zoomBy), null]) : (this.el.classList.add('to-the-left'), [null, width - ((x * zoomBy) - (panX * zoomBy))]), left = _ref2[0], right = _ref2[1];
      _ref3 = y < height / 2 ? (this.el.classList.remove('from-the-bottom'), [(y * zoomBy) - (panY * zoomBy), null]) : (this.el.classList.add('from-the-bottom'), [null, height - ((y * zoomBy) - (panY * zoomBy))]), top = _ref3[0], bottom = _ref3[1];
