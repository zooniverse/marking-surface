...
(function() {
  var BaseClass, CASE_SENSITIVE_ATTRIBUTES, Mark, MarkingSurface, POINTER_EVENTS, SVG, SVG_NS, Tool, ToolControls, _ref,
  ...
  BaseClass = (function() {
    ...
    BaseClass.prototype.off = function(eventName, handler) {
      var fn, handlerList, i, property, _i;
      if (eventName != null) {
  ...
  ToolControls = (function(_super) {
    ...
    function ToolControls() {
      ...
      this.tool.surface.container.appendChild(this.el);
    }

    ToolControls.prototype.onToolInitialRelease = function() {
      if (this.tool.isComplete()) {
        this.el.setAttribute('complete', 'complete');
      }
      return null;
    };
  ...
  Tool = (function(_super) {
    ...
    function Tool() {
      ...
      this.group = this.surface.svg.addShape('g.marking-tool');
