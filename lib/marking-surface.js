...
(function() {
  var BaseClass, CASE_SENSITIVE_ATTRIBUTES, ElementBase, FILTER_ID_PREFIX, KEYS, LOG_EVENTS, Mark, MarkingSurface, NAMESPACES, NON_ATTRIBUTE_PROPERTIES, SVG, Tool, ToolControls, ToolFocusTarget, ToolLabel, focusFilter, focusMerge, insertStyle, invertFilter, invertTransfer, matchesSelector, shadowFilter, shadowMerge, _ref, _ref1,
    __slice = [].slice,
  ...
  ToolControls = (function(_super) {
    ...
    function ToolControls() {
      ...
      this.tool.on('added', [this, 'followTool']);
      this.tool.on('select', [this, 'toFront']);
      this.tool.on('select', [this, 'attr', 'data-selected', true]);
      this.tool.on('deselect', [this, 'attr', 'data-selected', null]);
      this.tool.on('remove', [this, 'remove']);
  ...
  Tool = (function(_super) {
    ...
    function Tool() {
      ...
      this.mark.on('destroy', [this, 'destroy']);
    ...
    Tool.prototype.setMarkingSurface = function(markingSurface) {
      this.markingSurface = markingSurface;
      if (__indexOf.call(this.markingSurface.tools, this) < 0) {
        this.remove();
        this.markingSurface.addTool(this);
      }
      return this.rescale(this.markingSurface.getScale());
    };

    Tool.prototype.onMarkChange = function(property, value) {
      var _name, _ref2, _ref3, _ref4;
      if (typeof this.render === "function") {
        this.render(property, value);
      }
      if ((_ref2 = this.render) != null) {
        if ((_ref3 = _ref2[property]) != null) {
          if (typeof _ref3.call === "function") {
            _ref3.call(this, value);
          }
        }
      }
      if (typeof this[_name = (_ref4 = this.render) != null ? _ref4[property] : void 0] === "function") {
        this[_name]();
      }
    ...
    Tool.prototype.handleEvent = function() {
      if (!(this.disabled || this.markingSurface.disabled)) {
  ...
  MarkingSurface = (function(_super) {
    ...
    MarkingSurface.prototype.addTool = function(tool) {
      ...
      if (tool.markingSurface !== this) {
        tool.setMarkingSurface(this);
      }
      tool.rescale(this.getScale());
    ...
    MarkingSurface.prototype.onChange = function() {
      var _ref2;
      return (_ref2 = this.input) != null ? _ref2.el.value = this.getValue() : void 0;
    };
