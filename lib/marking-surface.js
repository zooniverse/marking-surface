...
(function() {
  var BaseClass, CASED_ATTRIBUTES, Mark, MarkingSurface, SVG, SVG_NS, Tool, ToolControls, events,
  ...
  MarkingSurface = (function(_super) {
    ...
    MarkingSurface.prototype.onMouseDown = function(e) {
      var dragEvent, mark, releaseEvent, tool, _ref,
        _this = this;
      if (this.disabled) {
        return;
      }
      ...
      if (_ref = e.target, __indexOf.call(this.container.querySelectorAll("." + ToolControls.prototype.className + ", ." + ToolControls.prototype.className + " *"), _ref) >= 0) {
        return;
      }
      e.preventDefault();
