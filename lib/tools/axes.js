...
(function() {
  ...
  AxesTool = (function(_super) {
    ...
    AxesTool.prototype.onInitialStart = function(e) {
      var point, points, startProps, x, y, _i, _len, _ref;
      AxesTool.__super__.onInitialStart.apply(this, arguments);
      ...
      return this.mark.set(startProps);
    };

    AxesTool.prototype.onInitialMove = function(e) {
      var point, x, y, _ref;
      AxesTool.__super__.onInitialMove.apply(this, arguments);
      _ref = this.coords(e), x = _ref.x, y = _ref.y;
