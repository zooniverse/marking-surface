...
(function() {
  ...
  AxesTool = (function(_super) {
    ...
    AxesTool.prototype.initialize = function() {
      ...
      return this.dots = (function() {
        ...
        for (i = _i = 0; _i < 4; i = ++_i) {
          _results.push(this.addShape('circle', 0, 0, 8, {
            fill: 'red',
            stroke: 'white',
            'stroke-width': 2
          }));
    ...
    AxesTool.prototype.render = function() {
      ...
      this.cross.attr({
        path: ["M " + this.mark.p0[0] + " " + this.mark.p0[1], "L " + this.mark.p1[0] + " " + this.mark.p1[1], "M " + this.mark.p2[0] + " " + this.mark.p2[1], "L " + this.mark.p3[0] + " " + this.mark.p3[1]].join(',')
      });
      return this.controls.moveTo([(this.mark.p0[0] + this.mark.p1[0] + this.mark.p2[0] + this.mark.p3[0]) / 4, (this.mark.p0[1] + this.mark.p1[1] + this.mark.p2[1] + this.mark.p3[1]) / 4]);
    };
