...
(function() {
  ...
  AxesTool = (function(_super) {
    ...
    AxesTool.prototype.dotRadius = !!~navigator.userAgent.indexOf('iO') ? 20 : 10;
    ...
    AxesTool.prototype.initialize = function() {
      ...
      return this.mark.set({
        p0: [-(this.dotRadius * 2), -(this.dotRadius * 2)],
        p1: [-(this.dotRadius * 2), -(this.dotRadius * 2)],
        p2: [-(this.dotRadius * 2), -(this.dotRadius * 2)],
        p3: [-(this.dotRadius * 2), -(this.dotRadius * 2)]
      });
    };
