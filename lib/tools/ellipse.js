...
(function() {
  ...
  EllipseTool = (function(_super) {
    ...
    function EllipseTool() {
      ...
      this.outline.addEvent('marking-surface:element:start', [this, 'startDrag']);
      this.outline.addEvent('marking-surface:element:move', [this, 'moveOutline']);
      this.xHandle.addEvent('marking-surface:element:move', [this, 'dragXHandle']);
      this.yHandle.addEvent('marking-surface:element:move', [this, 'dragYHandle']);
    }
