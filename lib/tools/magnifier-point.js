...
(function() {
  ...
  MagnifierPointTool = (function(_super) {
    ...
    MagnifierPointTool.prototype.tag = MagnifierPointTool.prototype.tag + '.magnifier-point-tool';
    ...
    function MagnifierPointTool() {
      ...
      this.closeButtonGroup.addEvent('marking-surface:element:click', [this.mark, 'destroy']);
      ...
      this.deselectButtonGroup.addEvent('marking-surface:element:click', [this, 'deselect']);
