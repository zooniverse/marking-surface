...
(function() {
  ...
  MagnifierPointTool = (function(_super) {
    ...
    MagnifierPointTool.prototype.render = function() {
      var currentRadius, height, scale, scaledRadius, scaledStrokeWidth, width, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
      ...
      console.log(scale, (_ref4 = this.markingSurface) != null ? _ref4.scaleX : void 0, (_ref5 = this.markingSurface) != null ? _ref5.scaleY : void 0);
      if ((this.mark.x != null) && (this.mark.y != null)) {
        ...
        return (_ref6 = this.controls) != null ? _ref6.moveTo.apply(_ref6, this.getControlsPosition()) : void 0;
      }
    };
