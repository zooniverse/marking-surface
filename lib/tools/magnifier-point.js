...
(function() {
  ...
  MagnifierPointTool = (function(_super) {
    ...
    function MagnifierPointTool() {
      ...
      this.deselectButton = this.deselectButtonGroup.addShape('circle', {
        fill: 'black',
        stroke: 'currentColor'
      });
      this.deselectLine = this.deselectButtonGroup.addShape('path', {
        fill: 'none',
        stroke: 'white',
        transform: 'rotate(45)'
      });
    ...
    MagnifierPointTool.prototype.render = function() {
      ...
      if ((this.mark.x != null) && (this.mark.y != null)) {
        ...
        this.deselectButtonGroup.attr({
          transform: "translate(" + scaledRadius + ", 0)"
        });
        this.deselectButton.attr({
          r: scaledCloseButtonRadius,
          strokeWidth: scaledStrokeWidth
        });
        this.deselectLine.attr({
          strokeWidth: scaledStrokeWidth,
          d: "M " + (-0.7 * scaledCloseButtonRadius) + " 0 L " + (0.7 * scaledCloseButtonRadius) + " 0"
        });
