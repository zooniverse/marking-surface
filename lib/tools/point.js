...
(function() {
  ...
  PointTool = (function(_super) {
    ...
    function PointTool() {
      ...
      this.addEvent('move', 'circle', this.onMove);
    }

    PointTool.prototype.rescale = function(scale) {
      var scaledRadius, scaledStrokeWidth;
      PointTool.__super__.rescale.apply(this, arguments);
