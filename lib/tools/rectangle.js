...
(function() {
  ...
  RectangleTool = (function(_super) {
    ...
    RectangleTool.prototype.rescale = function(scale) {
      var handle, scaledHandleSize, scaledStrokeWidth, _i, _len, _ref, _results;
      RectangleTool.__super__.rescale.apply(this, arguments);
      scaledStrokeWidth = this.strokeWidth / scale;
      scaledHandleSize = this.handleSize / scale;
      this.outline.attr('strokeWidth', this.scaledStrokeWidth);
      _ref = this.handles;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        handle = _ref[_i];
        _results.push(handle.attr({
          r: scaledHandleSize,
