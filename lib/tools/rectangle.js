...
(function() {
  ...
  RectangleTool = (function(_super) {
    ...
    function RectangleTool() {
      ...
      this.onDragBottomLeftHandle = __bind(this.onDragBottomLeftHandle, this);
      this.onDragBottomRightHandle = __bind(this.onDragBottomRightHandle, this);
      this.onDragTopRightHandle = __bind(this.onDragTopRightHandle, this);
      this.onDragTopLeftHandle = __bind(this.onDragTopLeftHandle, this);
      this['on drag handles'] = __bind(this['on drag handles'], this);
    ...
    RectangleTool.prototype.initialize = function() {
      ...
      this.handles = [];
      this.handles.push(this.topLeftHandle, this.topRightHandle, this.bottomRightHandle, this.bottomLeftHandle);
    ...
    RectangleTool.prototype['on drag handles'] = function(e) {
      ...
      _ref1 = this.pointerOffset(e), x = _ref1.x, y = _ref1.y;
      dragMethod = x < this.creationCoords.x && y < this.creationCoords.y ? 'onDragTopLeftHandle' : x >= this.creationCoords.x && y < this.creationCoords.y ? 'onDragTopRightHandle' : x >= this.creationCoords.x && y >= this.creationCoords.y ? 'onDragBottomRightHandle' : x < this.creationCoords.x && y >= this.creationCoords.y ? 'onDragBottomLeftHandle' : void 0;
      return this[dragMethod](e);
    };

    RectangleTool.prototype.onDragTopLeftHandle = function(e) {
      var x, y, _ref1;
      _ref1 = this.pointerOffset(e), x = _ref1.x, y = _ref1.y;
      x -= this.handleSize / 2;
      y -= this.handleSize / 2;
    ...
    RectangleTool.prototype.onDragTopRightHandle = function(e) {
      var x, y, _ref1;
      _ref1 = this.pointerOffset(e), x = _ref1.x, y = _ref1.y;
      x += this.handleSize / 2;
      y -= this.handleSize / 2;
    ...
    RectangleTool.prototype.onDragBottomRightHandle = function(e) {
      var x, y, _ref1;
      _ref1 = this.pointerOffset(e), x = _ref1.x, y = _ref1.y;
      x += this.handleSize / 2;
      y += this.handleSize / 2;
    ...
    RectangleTool.prototype.onDragBottomLeftHandle = function(e) {
      var x, y, _ref1;
      _ref1 = this.pointerOffset(e), x = _ref1.x, y = _ref1.y;
      x -= this.handleSize / 2;
      y += this.handleSize / 2;
