...
(function() {
  ...
  RectangleTool = (function(_super) {
    ...
    function RectangleTool() {
      ...
      this.dragFromHandle = __bind(this.dragFromHandle, this);
      ...
      this['on mousedown bottomLeftHandle'] = __bind(this['on mousedown bottomLeftHandle'], this);
      this['on mousedown bottomRightHandle'] = __bind(this['on mousedown bottomRightHandle'], this);
      this['on mousedown topRightHandle'] = __bind(this['on mousedown topRightHandle'], this);
      this['on mousedown topLeftHandle'] = __bind(this['on mousedown topLeftHandle'], this);
    ...
    RectangleTool.prototype.mouseOffsetFromShape = null;
    ...
    RectangleTool.prototype.initialize = function() {
      ...
      handles = [this.topLeftHandle, this.topRightHandle, this.bottomRightHandle, this.bottomLeftHandle];
    ...
    RectangleTool.prototype['on mousedown'] = function(e) {
      return this.mouseDownCoords = this.pointerOffset(e);
    };

    RectangleTool.prototype['on mousedown outside'] = function() {
      return this.mouseOffsetFromShape = {
        x: this.mouseDownCoords.x - this.mark.left,
        y: this.mouseDownCoords.y - this.mark.top
      };
    };
    ...
    RectangleTool.prototype['on drag outside'] = function(e) {
      ...
      return this.mark.set({
        left: x - this.mouseOffsetFromShape.x,
        top: y - this.mouseOffsetFromShape.y
      });
    };
    ...
    RectangleTool.prototype.onFirstClick = function(e) {
      this['on mousedown'](e);
      return this.mark.set({
        left: this.mouseDownCoords.x - (this.defaultSize / 2),
        top: this.mouseDownCoords.y - (this.defaultSize / 2)
      });
    };

    RectangleTool.prototype.onFirstDrag = function(e) {
      return this.dragFromHandle(e);
    };

    RectangleTool.prototype['on mousedown topLeftHandle'] = function(e) {
    ...
    RectangleTool.prototype['on mousedown topRightHandle'] = function(e) {
      return this.mouseDownCoords = {
        x: this.mark.left,
        y: this.mark.top + this.mark.height
      };
    ...
    RectangleTool.prototype['on mousedown bottomRightHandle'] = function(e) {
      return this.mouseDownCoords = {
        x: this.mark.left,
        y: this.mark.top
      };
    ...
    RectangleTool.prototype['on mousedown bottomLeftHandle'] = function(e) {
      return this.mouseDownCoords = {
        x: this.mark.left + this.mark.width,
        y: this.mark.top
      };
    ...
    RectangleTool.prototype.dragFromHandle = function(e) {
      var dragMethod, x, y, _ref1;
      _ref1 = this.pointerOffset(e), x = _ref1.x, y = _ref1.y;
      dragMethod = x < this.mouseDownCoords.x && y < this.mouseDownCoords.y ? 'dragFromTopLeft' : x >= this.mouseDownCoords.x && y < this.mouseDownCoords.y ? 'dragFromTopRight' : x >= this.mouseDownCoords.x && y >= this.mouseDownCoords.y ? 'dragFromBottomRight' : x < this.mouseDownCoords.x && y >= this.mouseDownCoords.y ? 'dragFromBottomLeft' : void 0;
    ...
    RectangleTool.prototype['on mouseup'] = function() {
      return this.mouseOffsetFromShape = null;
    };
